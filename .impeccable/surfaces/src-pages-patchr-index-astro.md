---
version: 1
slug: "src-pages-patchr-index-astro"
primary_target: "src/pages/patchr/index.astro"
related_targets: ["src/pages/patchr/privacy.astro","src/pages/patchr/terms.astro"]
---
...
THESIS: A Discord-bot product site in the MEE6 / Carl.gg / YAGPDB canon (hero with Add to Discord, alternating feature rows proven by Discord product shots, commands, FAQ, one drenched CTA band, legal footer), executed with the personal site's Apple and Stripe craft. It refuses an icon-card feature wall and invented social proof.

OWN-WORLD: Patchr's brand kit. Deep ink #0E0C1A and ink #17142B dark grounds, mist #F4F2FA and white light grounds, pink #FF5E8A as the one action colour (ink text on pink), mint #3DDC97 and lilac #8B7CFF only as the Fix and Change badges. Inter Variable only: ExtraBold 800 display with tight tracking, Medium leads. Glossy 3D tile renders. Discord screens as product shots whose Discord greys stay inside the screen.
...
Two pink lines, one from a GitHub release and one from a /patch form, meet at the Patchr tile and leave as a single post.
